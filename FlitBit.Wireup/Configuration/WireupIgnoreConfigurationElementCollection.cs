...
namespace FlitBit.Wireup.Configuration
{
		...
		AbstractConfigurationElementCollection<WireupIgnoreConfigurationElement, string>
	{
		...
		/// </summary>
		public WireupIgnoreConfigurationElementCollection()
			: base("add", "clear", "remove")
		{
		...
		protected override string PerformGetElementKey(WireupIgnoreConfigurationElement element)
		{
			return element.AssemblyMatchSpec;
		}
	}
}